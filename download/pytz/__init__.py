...
from download.pytz.exceptions import AmbiguousTimeError
from download.pytz.exceptions import InvalidTimeError
from download.pytz.exceptions import NonExistentTimeError
from download.pytz.exceptions import UnknownTimeZoneError
from download.pytz.lazy import LazyDict, LazyList, LazySet  # noqa
from download.pytz.tzinfo import unpickler, BaseTzInfo
from download.pytz.tzfile import build_tzinfo
...
class _FixedOffset(datetime.tzinfo):
    ...
    def __repr__(self):
        return 'download.pytz.FixedOffset(%d)' % self._minutes
