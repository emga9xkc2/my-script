...
class Frame:
    ...
    ad_frame_type: typing.Optional[AdFrameType] = None

    #: Frame document's origin trials with at least one token present.
    origin_trials: typing.Optional[typing.List[OriginTrial]] = None
    ...
    def to_json(self):
        ...
        if self.ad_frame_type is not None:
            json['adFrameType'] = self.ad_frame_type.to_json()
        if self.origin_trials is not None:
            json['originTrials'] = [i.to_json() for i in self.origin_trials]
        return json
    ...
    def from_json(cls, json):
        return cls(
            ...
            ad_frame_type=AdFrameType.from_json(json['adFrameType']) if 'adFrameType' in json else None,
            origin_trials=[OriginTrial.from_json(i) for i in json['originTrials']] if 'originTrials' in json else None,
        )
